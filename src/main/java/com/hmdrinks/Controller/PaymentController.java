...
public class PaymentController {
    ...
    public ResponseEntity<?> createPayment(@RequestBody @Valid CreatePaymentVNPayReq req, HttpServletRequest httpRequest) {
    ...
    public ResponseEntity<?> createPaymentZaloPay(@RequestBody @Valid  CreatePaymentReq req, HttpServletRequest httpRequest) throws Exception {
        ResponseEntity<?> authResponse = supportFunction.checkUserAuthorization(httpRequest, req.getUserId());
    ...
    public ResponseEntity<?> createPaymentMomoPay(@RequestBody @Valid  CreatePaymentReq req, HttpServletRequest httpRequest) {
        ResponseEntity<?> authResponse = supportFunction.checkUserAuthorization(httpRequest, req.getUserId());
        ...
        return paymentService.createPaymentMomo(req.getOrderId(),req.getType());
    }

    @PostMapping("/create/credit/payOs")
    public ResponseEntity<?> createPaymentPayOs(@RequestBody @Valid  CreatePaymentReq req, HttpServletRequest httpRequest) {
        ResponseEntity<?> authResponse = supportFunction.checkUserAuthorization(httpRequest, req.getUserId());
        ...
        return paymentService.createPaymentATM(req.getOrderId(),req.getType());
    }

    @PostMapping("/create/cash")
    public ResponseEntity<?> createPaymentCash(@RequestBody @Valid  CreatePaymentReq req, HttpServletRequest httpRequest) {
        ResponseEntity<?> authResponse = supportFunction.checkUserAuthorization(httpRequest, req.getUserId());
        if (!authResponse.getStatusCode().equals(HttpStatus.OK)) {
            return authResponse;
        }
