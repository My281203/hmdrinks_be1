...
public class UserController {
    ...
    public ResponseEntity<?> updateUserInfoResponseResponseEntity(
            @RequestBody  @Valid UserInfoUpdateReq req, HttpServletRequest httpRequest
    ){
    ...
    public ResponseEntity<?> changePassword(@RequestBody @Valid ChangePasswordReq req,HttpServletRequest httpRequest) {
        ResponseEntity<?> authResponse = supportFunction.checkUserAuthorization(httpRequest, req.getUserId());
    ...
    public ResponseEntity<?> enableUser(@RequestBody @Valid IdReq req, HttpServletRequest httpRequest) {
        return  userService.enableAccount(req.getId());
    }

    @PutMapping(value = "/disable")
    public ResponseEntity<?> disableUser(@RequestBody @Valid IdReq req, HttpServletRequest httpRequest) {
