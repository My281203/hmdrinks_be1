...
public class FavouriteItemController {
    ...
    public ResponseEntity<?> createCartItem(@RequestBody @Valid  InsertItemToFavourite req, HttpServletRequest httpRequest){
    ...
    public ResponseEntity<?> ListFavourite(@RequestParam Language language){
        return favouriteItemService.listAllTotalFavouriteByProId(language);
    }

    @DeleteMapping(value = "/delete/{id}")
    public ResponseEntity<?> deleteOneItem(@RequestBody @Valid  DeleteOneFavouriteItemReq req, HttpServletRequest httpRequest){
