...
public class VNPayService {
    ...
    public InitPaymentResponse init(InitPaymentRequest request,String callback, String redirect) {
        var amount = request.getAmount() * DEFAULT_MULTIPLIER;
        var txnRef = request.getTxnRef();
        var returnUrl = buildReturnUrl(redirect);
    ...
    private String buildReturnUrl(String txnRef) {
        return String.format(txnRef, txnRef);
    }
