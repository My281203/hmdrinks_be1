...
class OrderControllerTest {
    ...
    void createOrder_Success() throws Exception {
        ...
        List<CRUDCartItemResponse> crudCartItemResponseList = new ArrayList<>();
    ...
    void getAllOrderByUserId_Success() throws Exception {
        ...
        when(ordersService.getAllOrderByUserId(anyString(), anyString(),anyInt(),any(Language.class))).thenReturn((ResponseEntity) ResponseEntity.status(HttpStatus.OK).body(listAllOrdersResponse));
    ...
    void getAllOrderByUserId_NotFound() throws Exception {
        ...
        when(supportFunction.validatePositiveId(eq("id"), eq(1)))
                .thenReturn(null);
        when(ordersService.getAllOrderByUserId(anyString(), anyString(),anyInt(),any(Language.class))).thenReturn((ResponseEntity) ResponseEntity.status(HttpStatus.NOT_FOUND).body("Not found user"));
    ...
    void getAllOrderByUserIdAndStatus_Success() throws Exception {
        ...
        when(ordersService.getAllOrderByUserIdAndStatus(anyString(), anyString(),anyInt(),any(Status_Order.class),any(Language.class))).thenReturn((ResponseEntity) ResponseEntity.status(HttpStatus.OK).body(listAllOrdersResponse));
    ...
    void getAllOrderByUserIdAndStatus_NotFound() throws Exception {
        ...
        when(supportFunction.validatePositiveId(eq("id"), eq(1)))
                .thenReturn(null);
        when(ordersService.getAllOrderByUserIdAndStatus(anyString(), anyString(),anyInt(),any(Status_Order.class),any(Language.class))).thenReturn((ResponseEntity) ResponseEntity.status(HttpStatus.NOT_FOUND).body("Not found user"));
    ...
    void detailItemOrder_Success() throws Exception {
        ...
        when(ordersService.detailItemOrders(anyInt(), ArgumentMatchers.any(Language.class))).thenReturn((ResponseEntity) ResponseEntity.ok(listItemOrderResponse));
        mockMvc.perform(get(endPointPath + "/detail-item/{orderId}?&language=VN",1))
                .andExpect(status().isOk())
    ...
    void detailItemOrder_NotFound() throws Exception {
        when(ordersService.detailItemOrders(anyInt(),ArgumentMatchers.any(Language.class))).thenReturn((ResponseEntity) ResponseEntity.status(HttpStatus.NOT_FOUND).body("Order not found"));
        mockMvc.perform(get(endPointPath + "/detail-item/{orderId}?language=VN",1))
                .andExpect(status().isNotFound())
                .andExpect(content().string("Order not found"))
                .andDo(print());
    ...
    @Test
    void getDetailOrder_Success() throws Exception {
        List<CRUDCartItemResponse> crudCartItemResponseList = new ArrayList<>();
        CreateOrdersResponse createOrdersResponse = new CreateOrdersResponse(
                1,
                "99 đường số 7, Linh Trung, Thủ Đức, Hồ Chí Minh",
        ...
        CRUDShipmentResponse response2 = new CRUDShipmentResponse(
                1,
                "",
                LocalDateTime.now(),
                LocalDateTime.now(),
        ...
        when(ordersService.getDetailOrder(anyInt(), any(Language.class))).thenReturn((ResponseEntity) ResponseEntity.status(HttpStatus.OK).body(detailOrderResponse));

        mockMvc.perform(MockMvcRequestBuilders.get(endPointPath +"/detail/1")
                        .param("language", String.valueOf(Language.VN)))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.order.phone").value("0769674810"))
                .andExpect(jsonPath("$.payment.orderId").value(1))
                .andExpect(jsonPath("$.shipment.customerName").value("Nhu Y"))
                .andDo(print());
    }


    @Test
    void getDetailOrder_NotFound() throws Exception {
        when(ordersService.getDetailOrder(anyInt(), any(Language.class))).thenReturn((ResponseEntity) ResponseEntity.status(HttpStatus.NOT_FOUND).body("Order not found"));
        mockMvc.perform(MockMvcRequestBuilders.get(endPointPath +"/detail/1")
                        .param("language", String.valueOf(Language.VN)))
                .andExpect(status().isNotFound())
                .andExpect(content().string("Order not found"))
